...
def create_filters(date=None, start_date=None, end_date=None,
    ...
    created_filter = {}
    if date:
        created_filter['date'] = date
    if start_date:
        created_filter['start_date'] = start_date
    if end_date:
        created_filter['end_date'] = end_date
    if distance_min:
        created_filter['distance_min'] = distance_min
    if distance_max:
        created_filter['distance_max'] = distance_max
    if velocity_min:
        created_filter['velocity_min'] = velocity_min
    if velocity_max:
        created_filter['velocity_max'] = velocity_max
    if diameter_min:
